...
//       if (!error){
//         let resObject = {};
//         resObject['_id'] = updateUser.id;
//         resObject['username'] = updateUser.username;
...
//   const idLogs = req.params._id;

//   User.findById(idLogs, (error, result) => {
//     if (!error){
//       const arrayLog = result.log;
//       const exercises = arrayLog.map(exercise => {
//         return{
